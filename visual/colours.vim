...
function! SetColours() abort
    ...
    call s:Hi('ColorColumn',  'NONE',           'NONE',    'Gray')
    ...
    call s:Hi('UserColourLCharBase',        'NONE', 'Gray','NONE')

    " Special chars
    call s:Hi('SpecialKey',                 'NONE', 'Gray','NONE')
    call s:Hi('NonText',                    'NONE', 'Gray','NONE')
    if hlexists('Whitespace')
        call s:Hi('Whitespace',             'NONE', 'Gray','NONE')
    endif

    " vim-gitgutter sign colours.
    call s:Hi('GitGutterAdd',               'bold', 'Green',   'NONE')
    call s:Hi('GitGutterChange',            'bold', 'Yellow',  'NONE')
    call s:Hi('GitGutterDelete',            'bold', 'Red',     'NONE')
    call s:Hi('GitGutterChangeDelete',      'bold', 'Magenta', 'NONE')
    ...
    call s:Hi('UserColourStatusModeOther',  'bold', 'Yellow',  'NONE')
    call s:Hi('UserColourStatusBuffer',     'bold', 'Blue',    'NONE')
    call s:Hi('UserColourStatusOk',         'bold', 'Green',   'NONE')
    call s:Hi('UserColourStatusFlag',       'bold', 'Red',     'NONE')
    call s:Hi('UserColourStatusPath',       'NONE', 'NONE',    'NONE')
    call s:Hi('UserColourStatusFileType',   'bold', 'Magenta', 'NONE')
    call s:Hi('UserColourStatusInfo',       'NONE', 'NONE',    'NONE')
    call s:Hi('UserColourStatusPosition',   'bold', 'Magenta', 'NONE')
    call s:Hi('UserColourStatusPercent',    'bold', 'Blue',    'NONE')
    ...
    call s:Hi('UserColourTabModified',      'bold', 'Magenta', 'NONE')
